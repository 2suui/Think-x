  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Clean nav container with subtle, elegant #f0d41f glow links */}
        <nav
      ...
      >
        {REASONS.map((r, i) => (
          ...
          >
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--color-ink-secondary)', lineHeight: 1.7, margin: 0, fontWeight: 500, fontFamily: '"A2Z", Arial, sans-serif' }}>
              {r.desc}
            </p>
          </div>
        ))}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
          {PILLARS.map((p, i) => (
            ...
            >
              ...
              <h3 style={{ fontFamily: '"A2Z", Arial, sans-serif', fontWeight: 700, fontSize: '1.25rem', color: 'var(--color-ink)', marginBottom: '12px' }}>
                {p.title}
              </h3>
              <p style={{ fontSize: '0.875rem', color: 'var(--color-ink-secondary)', lineHeight: 1.7, fontWeight: 500, fontFamily: '"A2Z", Arial, sans-serif' }}>
                {p.body}
              </p>
            </div>
          ))}
        ...
        {STEPS.map((s, i) => (
          <div key={s.num} className={`fade-in fade-in-delay-${i + 1}`} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
              ...
              <div>
                <h3 style={{ fontFamily: '"A2Z", Arial, sans-serif', fontWeight: 700, fontSize: '1.35rem', color: 'var(--color-ink)', marginBottom: '10px' }}>
                  {s.title}
                </h3>
          ...
          <div style={{ background: '#fff', padding: '0' }}>
            {FEATURES.map((f, i) => (
              ...
              >
                ...
                <div>
                  <h4 style={{ fontFamily: '"A2Z", Arial, sans-serif', fontWeight: 700, fontSize: '1.15rem', color: 'var(--color-ink)', marginBottom: '6px' }}>
                    {f.label}
                  </h4>
                  <p style={{ fontSize: '0.875rem', color: 'var(--color-ink-secondary)', fontWeight: 500, margin: 0, fontFamily: '"A2Z", Arial, sans-serif' }}>
                    {f.desc}
                  </p>
                </div>
              </div>
  ...
  return (
    <section id="product" style={{ padding: 'clamp(80px,10vw,140px) clamp(24px,5vw,120px)', maxWidth: '1280px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="detail-grid">
        ...
        <div>
          <h3 style={{ fontFamily: '"A2Z", Arial, sans-serif', fontWeight: 700, fontSize: '1.85rem', color: 'var(--color-ink)', marginBottom: '8px' }}>
            Inside Pages
          </h3>
          <p style={{ fontFamily: '"A2Z", Arial, sans-serif', fontStyle: 'italic', fontSize: '1.05rem', fontWeight: 600, color: 'var(--color-ink-secondary)', marginBottom: '40px' }}>
            내지 확대컷
          </p>
          <RULE />
